...
class Board:
    ...
    def __init__(self):
        ...
        #     [self.EMPTY, self.BLACK, self.EMPTY, self.BLACK, self.EMPTY, self.BLACK, self.EMPTY, self.EMPTY],  # B
        ...
        #     [self.WHITE, self.EMPTY, self.WHITE, self.EMPTY, self.EMPTY, self.EMPTY, self.WHITE, self.EMPTY],  # G
